...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> { // linia 75 zmieniam kolor
    ...
    public MyAdapter(ShowActivityFriend activity , List<Model> mList){
