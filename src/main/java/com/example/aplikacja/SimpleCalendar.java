...
//
    ...
    private void init(Context context) {
        ...
        setUserCurrentMonthYear(month,year);
        ...
        if (firstDayOfCurrentMonth != 1) {
            ...
            for (int i = firstDayOfCurrentMonth; i < firstDayOfCurrentMonth + daysInCurrentMonth; ++i) {
                if (currentDateMonth == chosenDateMonth
                    ...
                    days[i].setBackgroundColor(getResources().getColor(R.color.baby_blue1));
    ...
    public void onDayClick(View view) {
        ...
        if (selectedDayButton != null) {
            if (chosenDateYear == currentDateYear
                ...
                selectedDayButton.setBackgroundColor(getResources().getColor(R.color.baby_blue1));
